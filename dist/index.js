...
const command_1 = __nccwpck_require__(157);
const file_command_1 = __nccwpck_require__(11);
const utils_1 = __nccwpck_require__(687);
const os = __importStar(__nccwpck_require__(37));
 ...
 */
var markdown_summary_1 = __nccwpck_require__(260);
...
const http_client_1 = __nccwpck_require__(347);
const auth_1 = __nccwpck_require__(239);
...
const pm = __nccwpck_require__(584);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(243);
            }
            const agentOptions = {
